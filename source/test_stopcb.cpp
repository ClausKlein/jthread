...
void testStopCallbackInits()
{
    ...
    struct MyCallback
    {
        ...
        void operator()() const { std::cout << "MyCallback operator()\n"; }
    };
    ...
    std::cout << "-----\n";
    std::stop_callback cb13{token, [] { std::cout << "stop13\n"; }};
    ...
    static_assert(std::is_same_v<decltype(cb18)::callback_type, MyCallback>);
    ...
    static_assert(std::is_same_v<decltype(cb19)::callback_type, MyCallback>);
